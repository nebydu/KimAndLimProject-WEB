<template>
  <header>
    <h1><router-link to="/"><img alt="Vue logo" src="../../assets/logo3.png" width="100"></router-link></h1>
    <div class="menuWrap">
      <ul class="menu">
        <li><router-link to="/login">외부API</router-link></li>
        <li><router-link to="/hello">HelloAPI</router-link></li>
